...
st.sidebar.title("Zillow Data Dashboard")
...
# Add descriptions
descriptions = {
    "Market Overview": "Advanced market indicators including momentum, cycles, and investment metrics.",
    "Market Analysis": "Core market metrics and trends including prices, rentals, and inventory.",
    "Market Activity": "Current market metrics including inventory, new listings, and sales data."
}

st.sidebar.markdown(f"### About {category}\n{descriptions[category]}")
